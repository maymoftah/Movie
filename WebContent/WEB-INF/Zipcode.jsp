				...
				<div class="container">
					...
					<form class="navbar-form navbar-left" role="search" action="/Movie/Theatermoviesearch.html" method="get">
						<div class="form-group"> <p>Enter Zipcode</p></div>
							<div class ="form-group"><input type="text" name ="Zipcode" id="Zipcode" class="form-control">
						</div> 
						
						<div class="form-group">
  						<input type="radio" name="Searchmovie" value="Search_by_movies" checked> Search By Movie<br>
 						 <input type="radio" name="Search_by" value="Search_by_theatres"> Search By Theater<br>
 						 </div>
 						<div class="form-group"><p> Select Date </p></div>
 						<div class ="form-group"> <input type="text" class="form-control" name="date" id="datepicker">
